...
- **GitHub**: use [Report a vulnerability](https://github.com/amaanx86/azure-devops-agent-operator/security/advisories/new) (preferred)
...
For security-related questions, contact [amaanulhaq.s@outlook.com](mailto:amaanulhaq.s@outlook.com).
